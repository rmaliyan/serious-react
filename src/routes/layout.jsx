...
function MenuSubitemLargeScreen({ url }) {
  return (
    <Link className="px-1 w-full" to={url}>
...
function MenuItem({
  ...
  return (
    <div className="flex flex-col overflow-hidden border border-slate-500 lg:flex lg:content-center lg:justify-center lg:border-0">
      <div className="flex w-full justify-between pr-5 lg:mx-2 lg:items-center lg:justify-center lg:p-0">
        <Link
          onClick={() => setmenuOpen(!menuOpen)}
...
function MenuItemLargeScreen({
  ...
  return (
    <div className="flex flex-col border-0 content-center justify-center">
      <div className="flex :mx-2 items-center justify-center p-0">
        <Link
          onClick={() => setmenuOpen(!menuOpen)}
          className="flex p-0"
          to={url}
